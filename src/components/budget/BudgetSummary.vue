<template>
  <article class="kb-panel">
    <div
      class="d-flex flex-wrap align-items-start justify-content-between gap-2 kb-summary-head"
    >
      <div>
    ...
    <div
      class="d-flex justify-content-between mt-3 small fw-semibold kb-summary-usage"
    >
    ...
    <div
      class="progress mt-2"
      style="height: 1.1rem; background: var(--kb-gray-200)"
    >
      <div
        class="progress-bar"
        :style="{
