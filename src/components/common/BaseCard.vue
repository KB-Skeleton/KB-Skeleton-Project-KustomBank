<template>
  ...
  >
    ...
    <footer v-if="$slots.footer" class="mt-2 pt-2 border-top border-light-subtle">
      <slot name="footer" />
    </footer>
  </component>
</template>
...
const computedClasses = computed(() => {
  ...
  const clickableClass = (props.tag === 'button' || props.accent === 'brown') ? 'kb-clickable' : '';
...
<style scoped>
/* 버튼으로 사용될 때 스타일 초기화 */
button.kb-card, button.kb-panel {
